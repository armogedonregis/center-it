...
export default {
  ...
  theme: {
    extend: {
      backgroundImage: {
        main_bg_with_noise:
          "linear-gradient(180deg, #050C26 0%, #171E37 100%), url('/assets/images/noise_bg.png')",
        ...
        main_card_bg_second:
          "linear-gradient(285.67deg, rgba(24, 31, 56, 0.8) 0%, rgba(36, 43, 71, 0.8) 100%)",
        button_red: "linear-gradient(225.2deg, #BE3021 0%, #F27D71 100%)",
        about_card_bg:
          "linear-gradient(285.67deg, #0F1630 0%, #45548F 100%), linear-gradient(285.67deg, #181F38 0%, #242B47 100%)",
